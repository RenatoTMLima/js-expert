  ...
  it("#extractPeopleData", () => {
    ...
    const expected = [
      [
        ...
        "domiciliada a Rua dos bobos, zero, bairro Alphaville, S├úo Paulo. ",
      ].join("\n"),
      [
        "J├║lia Menezes, brasileira, solteira, CPF 297.947.800-81, residente e ",
        "domiciliada a Av. dos Estados, 99, bairro Jardins, S├úo Paulo. ",
      ].join("\n"),
    ];
